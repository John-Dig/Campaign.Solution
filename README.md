...
Follow the instructions in the LearnHowToProgram.com lesson ["Creating a Test Database: Exporting and Importing Databases with MySQL Workbench"](https://www.learnhowtoprogram.com/lessons/creating-a-test-database-exporting-and-importing-databases-with-mysql-workbench) to use the `Campaign_with_ef_core_dump.sql` file located at the top level of this repo to create a new database in MySQL Workbench with the name `to_do_list_with_ef_core`.

### Set Up and Run Project

1. Clone this repo.
2. Open the terminal and navigate to this project's production directory called "Campaign".
3. Within the production directory "Campaign", create a new file called `appsettings.json`.
...
5. Within the production directory "Campaign", run `dotnet watch run` in the command line to start the project in development mode with a watcher.
...
- https://www.learnhowtoprogram.com/c-and-net/database-basics/showing-mission-details-with-ef-core
